...
// Route: /profile/:uid  –  public read-only player card
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        } catch { /* subcollection not readable */ }
          ...
          {!loading && !notFound && profile && (
            <>
                ...
                <div className="pub-hero__body">
                  ...
                  <div className="pub-identity">
                    ...
                    <p className="pub-join">
                      ...
                      Joined {formatJoin(profile.createdAt)}
                    </p>
              ...
              <div className="pub-stats">
                {[
                  { val: level,                                     key: "Level"     },
                  { val: xp.toLocaleString(),                       key: "Total XP"  },
                  { val: totalSessions || "—",                      key: "Sessions"  },
                  {
                  ...
                  <div key={key} className="pub-stat">
                    ...
                    <span className="pub-stat__key">{key}</span>
                  </div>
                ))}
              </div>
